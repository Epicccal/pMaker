...
- **已实现 stack 模型**:层 eth / vlan(Dot1Q)/ ipv4 / gre / tcp / udp / dns / payload / raw_hex / http_request / http_response;
  next-proto 自动串接、TCP/UDP checksum 伪首部、DNS A/AAAA/CNAME/NS/PTR/MX/TXT、确定性时间戳、golden + gopacket 回读测试。
